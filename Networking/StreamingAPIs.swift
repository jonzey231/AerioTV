...
// progressive live stream has no manifest clock; the phone-local cast
// HLS proxy (Networking/CastHLSProxy) replaces it and works for
// non-Dispatcharr sources too. Same deletion Android made.
